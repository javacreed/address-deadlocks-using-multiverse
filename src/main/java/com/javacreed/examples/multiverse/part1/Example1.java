...
public class Example1 {
  ...
  public static void main(final String[] args) throws InterruptedException {
    final PojoAccount a = new PojoAccount(10);
    final PojoAccount b = new PojoAccount(5);

    // Transfer 5 from b to a
    a.transferBetween(b, 5);

    // Transfer 5 from a to b
    b.transferBetween(a, 5);

    Example1.LOGGER.debug("Account a: {}", a);
    Example1.LOGGER.debug("Account b: {}", b);
